...
async function scheduleRemindersForBudget(assignment, budget) {
  ...
  // Use the assignment's specific due time when set; fall back to 11:59 PM so
  // reminders are still useful for undated assignments.
  const [dueH, dueMin] = assignment.dueTime
