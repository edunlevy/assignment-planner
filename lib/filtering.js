...
// and excludes empty/whitespace-only course values. localeCompare, not the
// default comparator: course is free-text, and code-unit order puts
// "Zoology" before "algebra" and every accented name last.
